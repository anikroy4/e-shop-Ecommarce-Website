    ...
    <Container>
      <div className='flex items-center justify-between mb-24'>
        ...
        <h2 className=' font-["Poppins"] text-4xl font-semibold text-[#303030] leading-[46px] not-italic '>New Products</h2>
          <div className='flex items-center justify-end gap-2  text-[#FF624C] ' >
           <p className=' font-["Montserrat"] text-base font-b leading-6 text-[#303030]'> 
            ...
            " id="" className='font-["Montserrat"] text-base leading-6'>
       ...
       <div className='flex gap-2'>
            ...
            <ProductLayout percentTag={true}   category="Audio" title="WH-1000XM4 Wireless Headphones High Qu..." totalRating="120" rating="4" price="118.00" border={true} bg="transparent" stock={false} stockAmount="" isCircle={false}/>

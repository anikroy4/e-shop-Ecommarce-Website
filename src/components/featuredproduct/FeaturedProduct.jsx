  ...
  return (
    <Container>
      ...
      <Slider {...settings}>
        ...
        <ProductLayout percentTag={false} category="Laptop" title="S21 Laptop Ultra HD LED Screen Feature 2023..." totalRating="50" rating="5" price="999.00" border={true} bg="transparent" stock={false} stockAmount="" isCircle={false}/>
        <ProductLayout percentTag={true}   category="Audio" title="S21 Laptop Ultra HD LED Screen Feature 2023..." totalRating="120" rating="4" price="118.00" border={true} bg="transparent" stock={false} stockAmount="" isCircle={false}/>
        ...
        <ProductLayout percentTag={false}  category="camera" title="S21 Laptop Ultra HD LED Screen Feature 2023..." totalRating="70" rating="5" price="79.00" border={true} bg="transparent" stock={false} stockAmount="" isCircle={false}/>
        <ProductLayout percentTag={true}   category="Audio" title="S21 Laptop Ultra HD LED Screen Feature 2023..." totalRating="120" rating="4" price="118.00" border={true} bg="transparent" stock={false} stockAmount="" isCircle={false}/>

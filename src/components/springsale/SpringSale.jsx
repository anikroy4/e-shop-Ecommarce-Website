          ...
          <div className='flex justify-between '>
            ...
            <div className=' max-w-[902px]'>
              <Slider {...settings}>
                ...
                <ProductLayout changePadding='40px' TextSize='24px' className="hover:!bg-[#ffff] mr-6" percentTag={true} discount="45" category="camera" title="Mini Polaroid Camera for Girls with Flash Li..." totalRating="70" rating="5" price="79.00" border={true} bg="#EAEAEA" stock={true} stockAmount="500" isCircle={true}/>
                <ProductLayout changePadding='40px' TextSize='24px' className="hover:!bg-[#ffff] mr-6" percentTag={true} discount="50" category="Audio" title="WH-1000XM4 Wireless Headphones High Qu..." totalRating="120" rating="4" price="118.00" border={true} bg="#EAEAEA" stock={true} stockAmount="300" isCircle={true}/>

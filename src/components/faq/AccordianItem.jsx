...
const AccordianItem = ({title, content,onToggle, isOpen }) => {
  return (
    <div className="mb-6 w-full bg-white  text-left py-8 px-12 rounded-[25px] font-['Poppins'] text-[#303030]  font-semibold leading-[30px] relative pl-[112px]" onClick={onToggle} >
        <button>
       ...
       { isOpen &&
        <div className='pt-[16px]  font-["Montserrat"] font-normal text-xl leading-[30px] text-[#646464]'>
            {content}
        </div>
